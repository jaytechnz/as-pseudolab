...
ex('ope-09','operators','Recipe Serving Size','medium',
`INPUT two integers \`Servings\` and \`CaloriesPerServing\`. OUTPUT a summary in the format: \`Servings: 4, Calories per serving: 250\` (or whatever values are entered).`,
[t(['4','250'],['Servings: 4, Calories per serving: 250']), t(['12','90'],['Servings: 12, Calories per serving: 90'])],
...
['Consider using CASE OF with ranges, e.g. CASE OF StatusCode / 200 TO 299 : ...', 'A CASE statement is cleaner than a chain of ELSE IF when testing a single variable against multiple ranges']),
